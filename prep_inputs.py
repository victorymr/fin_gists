...
def save_todb(gc):
  ...
  def on_button_clicked(b):
    ...
    ## now write to BD
    write_rowDB(gc,ndfts.values.tolist(),sheetn='Ticker',filn='StockDB')
    write_rowDB(gc,ndfls.values.tolist(),sheetn='Lease',filn='StockDB')
    write_rowDB(gc,ndfos.values.tolist(),sheetn='Optionholdings',filn='StockDB')
