...
def save_todb(gc):
  ...
  def on_button_clicked(b):
    ...
    ## now write to BD
    write_rowDB(gc,ndfts.values,sheetn='Ticker',filn='StockDB')
    write_rowDB(gc,ndfls.values,sheetn='Lease',filn='StockDB')
    write_rowDB(gc,ndfos.values,sheetn='Optionholdings',filn='StockDB')
