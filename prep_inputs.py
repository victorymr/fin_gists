...
def export_to_sheets(workbook="StockDB",worksheet_name,df,mode='r'):
...
def save_todb(gc):
  ...
  def on_button_clicked(b):
    ...
    ## now write to BD
    export_to_sheets(worksheet_name='Ticker',ndfts,mode='a')
    export_to_sheets(worksheet_name='Lease',ndfls,mode='a')
    export_to_sheets(worksheet_name='Optionholdings',ndfos,mode='a')
